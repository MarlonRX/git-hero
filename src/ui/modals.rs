...
pub fn draw_docs_modal(f: &mut Frame, s: &mut AppState) {
    ...
    let lines: Vec<&str> = if s.language == "es" {
        vec![
            ...
            "",
            "\u{2699} Gesti\u{00F3}n de cambios",
            "  Space (archivo)       Marca/desmarca un archivo para commit",
            "  a  /  /stage-all      Prepara (stage) todos los cambios",
            "  u  /  /unstage-all    Quita todo del stage",
            "  c  /  /commit <msg>   Crea un commit; auto-stagea si es necesario",
            "  r  /  /undo-commit    Deshace ultimo commit (soft reset)",
            "",
            "\u{2699} Ramas y remoto",
            "  b  /  /branches       Lista todas las ramas",
            "  n  /  /branch <name>  Crea rama nueva y cambia a ella",
            "  /switch <name>        Cambia a una rama existente",
            "  o  /  /remote <url>   Cambia URL del remote 'origin'",
            "",
            "\u{2699} Sync (fetch/pull/push)",
            "  f  /  /fetch          Descarga metadatos (sin fusionar)",
            "  l  /  /pull           Descarga + fusiona cambios",
            "  p  /  /push           Sube commits locales al remoto",
            "",
            "\u{2699} Stash",
            "  s  /  /stash          Guarda cambios locales en stash",
            "  d  /  /stash-pop      Recupera cambios del stash",
            "",
            "\u{2699} Config",
            "  /config <k> [v]       Lee o escribe config local",
            "  /config-global <k><v> Escribe config global (~/.gitconfig)",
            "",
            "\u{2699} Otros",
            "  t  /  /themes        Selector de temas visuales",
            "  /remove-repo         Elimina .git (sin confirmacion!)",
            "  /docs               Esta referencia detallada",
            "  ?  /  /help          Ayuda rapida de atajos",
        ]
    } else {
        vec![
            "\u{2501}\u{2501}\u{2501}\u{2501}\u{2501}\u{2501}\u{2501}\u{2501}\u{2501}\u{2501}\u{2501}\u{2501}\u{2501}\u{2501}\u{2501}\u{2501}\u{2501}\u{2501}\u{2501}\u{2501}\u{2501}\u{2501}\u{2501}\u{2501}\u{2501}\u{2501}\u{2501}",
